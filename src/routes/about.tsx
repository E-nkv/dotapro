...
function About() {
    const popularTeams = getPopularData().popular_teams
    ...
    return (
        <>
            ...
            <div className="mx-4 min-h-[calc(100vh-4rem)] max-w-4xl space-y-8 py-6 sm:mx-auto">
                ...
                <Card className="border-border/50">
                    <CardContent className="pt-6">
                        ...
                        <p className="text-muted-foreground mb-4 leading-relaxed">
                            dotapro covers professional matches from premium and professional tier leagues — the games
                            that matter on the pro circuit. While established platforms like Dotabuff, Stratz, and
                            OpenDota offer comprehensive data across all matches, dotapro's focus is different.
                        </p>
                ...
                <Card id="popular-teams" className="border-border/50">
                    <CardContent className="pt-6">
                        <h2 className="text-foreground mb-4 text-xl font-semibold">Popular teams</h2>
                        ...
                        <p className="text-muted-foreground mt-4 text-sm">
                            Quick links to well-known teams — not a filter on what dotapro shows.
                        </p>
                    </CardContent>
                </Card>
